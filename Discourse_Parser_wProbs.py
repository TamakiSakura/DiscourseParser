...
def preprocess(ts_edufile):
    ...
    SynFeatures.extractDomSets("tmp.chp", "tmp.fmt",ts_edufile)#okay
...
def do_parse(infile):
    ...
    Parse_wProbs.parse('parse_sen.rel', 'tmp_sen.prob', "tmp_sen.feat", "tmp_sen.dis", 'parse_doc.rel', 'tmp_doc.prob', "tmp_doc.feat", "tmp_doc.dis", "tmp.edu")
